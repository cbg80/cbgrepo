...
class Post
{
     ...
     *            Brief description of the post of context
     * @param string $imageFileName
     *            File name of the image of the post of context
     * @param string $timestamp
     *            Timestamp of the post of context
     * @param int $id
     *            Unique indentifier of the post of context
     */
